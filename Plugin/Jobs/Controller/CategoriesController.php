 ...
 */
class CategoriesController extends JobsAppController {
 ...
 */
	public function admin_add() {
		if ($this->request->is('post')) {
			$this->Category->create();
			if ($this->Category->save($this->request->data)) {
				$this->Session->setFlash(__d('croogo', 'موضوع مورد نظر ایجاد شد.'), 'default', array('class' => 'success'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__d('croogo', 'The category could not be saved. Please, try again.'), 'default', array('class' => 'error'));
			}
 ...
 */
	public function admin_edit($id = null) {
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			if ($this->Category->save($this->request->data)) {
				$this->Session->setFlash(__d('croogo', 'موضوع مورد نظر ویرایش شد.'), 'default', array('class' => 'success'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__d('croogo', 'The category could not be saved. Please, try again.'), 'default', array('class' => 'error'));
			}
 ...
 */
	public function admin_delete($id = null) {
		...
		$this->request->onlyAllow('post', 'delete');
		if ($this->Category->delete()) {
			$this->Session->setFlash(__d('croogo', 'موضوع حذف شد'), 'default', array('class' => 'success'));
			$this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__d('croogo', 'Category was not deleted'), 'default', array('class' => 'error'));
		$this->redirect(array('action' => 'index'));
